...
public class Graph {
	...
	public void removeEdge(String vname1, String vname2) {
		...
		vtx2.nbrs.remove(vname1); // 2k nbrs remove A
	}
	...
	public void bft() {
		...
		ArrayList<String> keys = new ArrayList<>(vtces.keySet());
		// for ervy node repeat the process
		for (String key : keys) {
	...
	public boolean istree() {
		// we will always have n-1 edges in tree
	...
	public ArrayList<ArrayList<String>> getCC() {
		...
		for (String key : keys) {
			...
			// for new compoment create a new arraylist
	...
	public Graph prims() {
		...
		while (!heap.isempty()) {
			...
			// works for nbrs which are in heap

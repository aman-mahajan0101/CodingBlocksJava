...
import java.util.*;
public class StructurallyIdentical_BinaryTree {
    static Scanner scn = new Scanner(System.in);
    public static void main(String[] args) {
        StructurallyIdentical_BinaryTree m = new StructurallyIdentical_BinaryTree();
    ...
    private class BinaryTree {
        ...
        boolean lt=structurallyIdentical(node1.left,node2.left);
        boolean rt=structurallyIdentical(node1.right,node2.right);
        return lt&&rt;

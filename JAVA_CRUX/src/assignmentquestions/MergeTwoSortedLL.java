...
class MergeTwoSortedLL {
	...
	public void merge_sorted_list(MergeTwoSortedLL other) throws Exception {

		MergeTwoSortedLL dis = merge_sorted_list1(other);
		dis.display();
	}

	public MergeTwoSortedLL merge_sorted_list1(MergeTwoSortedLL other) throws Exception {

		MergeTwoSortedLL sorted = new MergeTwoSortedLL();

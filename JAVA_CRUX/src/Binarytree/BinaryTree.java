...
public class BinaryTree {
	...
	//create tree using post and inorder
	
//	public BinaryTree(int[] post, int[] in) {
//		this.root = this.construct1(post, 0, post.length - 1, in, 0, in.length - 1);
//	}
//
...
//	}
	...
	private class bstpair { // class for checking binary tree is bst or not
		boolean isbst = true;
	...
	private bstpair istreebst(Node node) {
		...
		sbp.max = Math.min(node.data, Math.min(lbp.max, rbp.max));
